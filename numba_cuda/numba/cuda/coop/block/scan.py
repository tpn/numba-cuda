...
class scan:
    def __init__(
        ...
        :param dim: Supplies the number of threads in the block,
        ...
        if items_per_thread < 1:
            raise ValueError(
                "items_per_thread must be greater than or equal to 1"
            )
        ...
        specialization_kwds = self.specialization_kwds = {
            "T": dtype,
            "BLOCK_DIM_X": dim[0],
        ...
        if block_prefix_callback_op is not None:
            specialization_kwds["BlockPrefixCallbackOp"] = (
